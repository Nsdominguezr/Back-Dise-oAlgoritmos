"""Módulo de configuración del API Gateway."""
...
class Config:
    ...
    Attributes:
        PORT: Puerto donde correrá el Gateway.
        MICROSERVICIOS: Diccionario de enrutamiento hacia los microservicios.
    """
