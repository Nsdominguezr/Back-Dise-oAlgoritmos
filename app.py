"""Aplicación Flask del API Gateway.

Punto de entrada para el servicio de enrutamiento gateway.
"""
...
def create_app():
    ...
    # Habilitar CORS globalmente para que Angular pueda hacer peticiones
    # sin ser bloqueado.
